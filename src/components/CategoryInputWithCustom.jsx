// =====================================================
// COMPONENTE: CategoryInputWithCustom
// =====================================================
// Input de categoría con soporte para texto libre y categorías personalizadas
// =====================================================
...
export const CategoryInputWithCustom = ({
  value,
  onChange,
  options = [],
  customCategories = [],
  ...
  // Combinar opciones predefinidas con categorías personalizadas
  const allOptions = [
    ...options,
  ...
  const handleSelectOption = (option) => {
    if (option.id === 'personalizar-ingreso' || option.id === 'personalizar-gasto') {
      setIsTextMode(true);
      setInputValue('');
      onChange('');
    } else {
  ...
  const handleDeleteCustom = (e, categoryId) => {
    e.stopPropagation();
    if (onDeleteCustom) {
      onDeleteCustom(categoryId);
    }
  };
