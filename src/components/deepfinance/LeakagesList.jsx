      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-xl bg-orange-500/10 border border-orange-500/20">
            <Icon component={Droplet} size="md" color="default" className="dark:" />
          </div>
          <h3 className="text-lg font-bold text-[#1a1a1a] dark:text-white">
            Fugas de Dinero Detectadas
          </h3>
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <Icon component={AlertTriangle} size="sm" color="default" className="dark:" />
                  ...
                  <div className="flex flex-wrap gap-4 text-xs">
                    ...
                    <div className="flex items-center gap-1">
                      <Icon component={DollarSign} size="xs" color="default" />
                      <span className="text-[#6E6E73] dark:text-gray-400">
