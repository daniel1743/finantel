    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F5F7F9] p-4 relative overflow-hidden">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative group">
            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#6E6E73] group-focus-within:text-[#1C8FA0] transition-colors" />
            <input
              type="password"
          ...
          <AnimatePresence mode="wait">
            {!isLogin && (
              ...
              >
                <div className="relative group">
                  <CheckCircle2 className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#6E6E73] group-focus-within:text-[#1C8FA0] transition-colors" />
                  <input
                    type="password"
        ...
        <div className="mt-8 pt-6 border-t border-gray-100">
          <div className="grid grid-cols-2 gap-4 mb-6">
            <button className="flex items-center justify-center gap-2 py-2.5 px-4 bg-white border border-gray-200 rounded-xl text-sm font-medium text-[#6E6E73] hover:bg-gray-50 hover:text-[#1a1a1a] transition-colors">
