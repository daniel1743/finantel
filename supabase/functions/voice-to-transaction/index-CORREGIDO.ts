// Edge Function: voice-to-transaction (VERSIÓN CORREGIDA)
...
serve(async (req) => {
  ...
  try {
    ...
    const { audio, userId, mimeType } = await req.json()
    ...
    if (!whisperResponse.ok) {
      ...
      throw new Error('Error al transcribir audio con Whisper')
    }
    ...
    console.log('Categoría ID encontrada:', categoryId)
