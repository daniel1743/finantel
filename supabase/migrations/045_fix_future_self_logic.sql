-- ============================================================================
-- FIX: Lógica Corregida del Future Self Simulator
-- ============================================================================
-- Corrige el error donde el "Escenario Mejorado" mostraba resultados peores
-- que el "Escenario Actual". Ahora garantiza coherencia lógica.
-- ============================================================================
-- NOTA: Esta migración SOLO actualiza la función. No crea tablas ni índices.
-- Si obtienes errores sobre índices existentes, ignóralos o ejecuta solo
-- la parte de la función (líneas 8-173).
-- ============================================================================
